...
class SpeculativeConfig:
    ...
    def create_draft_parallel_config(
        ...
        draft_parallel_config = ParallelConfig(
            # Draft models are instantiated only on the target's last PP rank.
            # They must therefore own their complete layer stack rather than
            # inheriting the target model's pipeline partition.
